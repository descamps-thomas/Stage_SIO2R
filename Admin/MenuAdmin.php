...
<div class="w3-top">
  ...
  <div id="navDemo" class="w3-bar-block w3-white w3-hide w3-hide-large w3-hide-medium">
    ...
    <a href="../Menu.php" class="w3-bar-item w3-button" onclick="toggleFunction()">Deconnexion</a>
  </div>
</div>
...
<center><h2>MENU D'ADMINISTRATION</h2></center>
</header>
<br>
<center>
<?php
...
if (!isset($_SESSION['typeuser']) || !isset($_SESSION['login'])) {
...
if ($_SESSION['typeuser'] == "1") {
    ?>
    <a href="Affiche.php" class="w3-button w3-light-grey"><i class="fa-solid fa-users w3-margin-right"></i>Afficher les utilisateurs</a>
    <br>
    <br>
    <a href="Creareserv.php" class="w3-button w3-light-grey"><i class="fa-regular fa-square-plus w3-margin-right"></i>Créé un événement</a>
    <br>
    <br>
    <a href="../Affichepartie.php" class="w3-button w3-light-grey"><i class="fa-solid fa-calendar w3-margin-right"></i>Afficher les événement</a>
    <br>
    <br>
    <a href="Compta.php" class="w3-button w3-light-grey"><i class="fa-solid fa-euro-sign w3-margin-right"></i>Trésorie</a>
    <br>
    <br>
    <a href="Cms.php" class="w3-button w3-light-grey"><i class="fa-regular fa-image w3-margin-right"></i>CMS</a>
