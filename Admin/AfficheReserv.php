...
<center><h2>AFFICHE UTILISATEUR </h2></center>
</header>
<br><br><br>
<?php
...
$requete1 = $bdd->prepare("SELECT reservation.*, User.nom AS UserNom, Partiepeche.nom AS PartiepecheNom, User.prenom AS Userprenom, Partiepeche.date AS Partiepechedate
                            FROM reservation 
                            JOIN User ON reservation.userid = User.id
                            JOIN Partiepeche ON reservation.partiepecheid = Partiepeche.id
    ...
    <body>
        ...
        <table class="w3-table-all w3-centered">
                ...
                <?php foreach ($resultat as $donne) { ?>
                    <tr>
                        <td><?php echo $donne['UserNom']; ?></td>
                        <td><?php echo $donne['Userprenom']; ?></td>
                        <td><?php echo $donne['PartiepecheNom']; ?></td>
                        <td><?php echo $donne['nbrplacer']; ?></td>
                        <td><?php echo $donne['dater']; ?></td>
                        <td><?php echo $donne['Partiepechedate']; ?></td>

                        <td>
                        <form action="Supprimeresev.php" method="get" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet élément ?')">
                        <input type="hidden" name="id" value="<?php echo $donne['partiepecheid']; ?>">
                        <input type="hidden" name="id_partie" value="<?php echo $donne['userid']; ?>">
                        <button type="submit">
