...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $nouveauRole = ($_POST['etat'] % 2) + 1;  

    $idToUpdate = $_POST['id'];
    echo "ID à mettre à jour : " . $idToUpdate . "<br>"; 
    echo "Rôle actuel : " . $_POST['etat'] . "<br>"; 
    echo "Nouveau rôle : " . $nouveauRole . "<br>"; 

    $requete_modification_role = "UPDATE Partiepeche SET etat = :nouveauRole WHERE id = :id";
    ...
    try {
        ...
        header('Location: ../Affichepartie.php');
        exit();
