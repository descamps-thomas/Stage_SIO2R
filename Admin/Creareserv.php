...
<div class="center-content">
    ...
    if (!isset($_SESSION['typeuser']) || !isset($_SESSION['login']) || ($_SESSION['typeuser'] != "1" )) {
        ...
        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
            ...
            $HORAIRE = strtolower(trim($_POST['horaire']));
            $ETAT = 2;
        
            try {
                $requete = $bdd->prepare("INSERT INTO Partiepeche (nom, nombremax, date, etangid, typepecheid,etat, horaire) VALUES(:nom, :nombremax, :date, :etangid, :typepecheid, :etat, :horaire)");
