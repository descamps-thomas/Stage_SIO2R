        ...
        <table class="w3-table-all w3-centered">
                ...
                <?php foreach ($resultat as $donne) { ?>
                    <tr>
                        ...
                        <td>
                        <a href="Supprimeresev.php?id=<?php echo $donne['partiepecheid']; ?>&id_partie=<?php echo $donne['userid']; ?>">
                        <img src="Images/delete.png" alt="affiche" style="width: 20px; height: 20px;">
                        </a>
