...
?>
    ...
    <tbody>
        <tr>
            ...
            <td><input type="text" name="prenom" value="<?php echo htmlspecialchars($nomStocke); ?>" readonly disabled></td>
        </tr>
        <tr>
            <td><label>Prénom</label></td>
            <td><input type="text" name="prenom" value="<?php echo htmlspecialchars($prenomStocke); ?>" readonly disabled></td>
        </tr>
        <tr>
            <td><label>Email</label></td>
            <td><input type="email" name="email" value="<?php echo htmlspecialchars($emailStocke); ?>" readonly disabled></td>
        </tr>
        ...
        <form action="Gestcompte.php" method="POST">
            ...
            <tr>
                ...
                <td><input type="password" required="" name="confirm_mdp" minlength="6" maxlength="32"></td>
            </tr>
        </tbody>
    </table>
