...
if ($_SESSION['typeuser'] == "1") {
    ?>
    <a href="Affiche.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Afficher la BDD</a>
    <a href="Gestcompte.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Gestion du compte</a>
    <br>
    <br>
    <a href="Creareserv.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Créé un événement</a>
    <a href="Affichepartie.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Afficher les événement</a>
    <a href="Compta.php" class="w3-button w3-light-grey"><i class="fa fa-arrow-up w3-margin-right"></i>Compta</a>
