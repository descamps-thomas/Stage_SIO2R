...
if ($_SESSION['typeuser'] == "1") {
    ...
    <a href="Admin/MenuAdmin.php" class="w3-button w3-light-grey"><i class="fa-regular fa-gem w3-margin-right"></i>Administration</a>
    <br>
    <br>
    <a href="Gestcompte.php" class="w3-button w3-light-grey"><i class="fa-solid fa-gear w3-margin-right"></i>Gestion du compte</a>
