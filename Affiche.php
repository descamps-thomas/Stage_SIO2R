            ...
            <table class="w3-table w3-striped w3-border">
                ...
                <?php foreach ($resultat as $donne) { ?>
                    <tr>
                        ...
                        <td><?php echo $donne['typeuser']; ?></td>

                        <td>
                            <a href="Supprimeuser.php?id=<?php echo $donne['id']; ?>" onclick="return confirm('Êtes-vous sûr de vouloir supprimer cet utilisateur ?')">
                                <img src="Images/delete.png" alt="Supprimer" style="width: 20px; height: 20px;">
                            </a>
                            <a href="ModifierRole.php?id=<?php echo $donne['id']; ?>">
                                <img src="Images/edit.png" alt="Modifier le rôle" style="width: 20px; height: 20px;">
                            </a>
                        </td>
                    </tr>
                <?php } ?>
