...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $bdd->exec($requete_modification_role);
...
$requete_utilisateur = "SELECT * FROM User WHERE id = $id";
$resultat_utilisateur = $bdd->query($requete_utilisateur);
$utilisateur = $resultat_utilisateur->fetch();
?>
...
<html>
    <center>
        <form method="post" action="">
            ...
            <label for="nouveau_role">Nouveau rôle :</label>
            <select name="nouveau_role" id="nouveau_role">
